...
MissionCondition1 = [ 
 "WIN", { triggerActivated (Escape) && triggerActivated (WinTrigger) }, 
 "All objectives done"
];
...
MissionCondition3 = [ 
 "WIN2", { triggerActivated (Escape) && Colonel inArea Escape }, 
 "All objectives done"
];

MissionCondition4 = [ 
 "WIN3", { triggerActivated (Escape) && triggerActivated (WinTrigger_2) }, 
 "All objectives done"
];

MissionCondition5 = [ 
 "WIN4", { triggerActivated (Escape) && triggerActivated (WinTrigger_3) }, 
 "All objectives done"
];

MissionCondition6 = [ 
 "WIN5", { triggerActivated (Escape) && triggerActivated (WinTrigger_3) && Colonel inArea Escape }, 
 "All objectives done"
];